...
<Helmet>
   ...
   <figure className='u-photo blogFigure'>
    ...
    <p className = 'e-content'>To end the internet artwork, I have created a mock social media feed page. The user is prompted to make a post but when adding text, the user is notified that the site has been sued for parody and therefore cannot sign users up. This final disappointment means that the reason for putting oneself through this terrible form is for nothing and therefore effort was wasted. The end of the artwork, therefore, feels like a cruel joke to the user as the product promised is not delivered. Find the Post Area <Link to='/Post'>here</Link>&nbsp;</p>
   <figure className='u-photo blogFigure'>
