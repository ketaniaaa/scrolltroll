...
<Helmet>
        ...
        <meta name='author' content='Ketania Govender'/>
          <meta name="description" content="Bias in Natural Language Processing and Autocorrection."/>
    ...
    <meta
      property="og:url" content="https://ketaniaaa.github.io/scrolltroll/#/EssayBlog"/>
       <meta name="keywords" content="Internet Art, AI art, ethics of ai, nlp, low-resouce languages, natural language processing, ai , ml, african language technology, ai bias, algoritmic bias, technological colonialism, essay"/>
      </Helmet>
 ...
 <ShareButton/>
        ...
        <h1 className='blogTitle p-name'>Bias in Natural Language Processing and Autocorrection.&nbsp; </h1>
...
<p>Nobel coined the phrase &ldquo;technological redlining&rdquo; in her book Algorithms of Oppression (2018, pp18). This term refers to the embedded prejudice in the code that we interact with. As previously discussed, the embedded bias due to disparity in resources can be found often in natural language processing. To explain this bias, it is prudent to initially understand that NLP works using a corpus of training material. To train an NLP model, one requires a large body of documented language. This means that languages native to the global south become less documented due to the historic inability to access information wells. Low-resource languages therefore cannot have adequate NLP training subsequently resulting in an inability to use this feature. This, therefore, further bars these communities from participating in the creation and diffusion of information and results in heightened technological redlining. There is thus an inability to cater for cultural variation in NLP(Hovy &amp; &nbsp; Prabhumoye. 2021, pp7). This demonstrates the prejudice in the code that we interact with and explains the autocorrect of the vernacular. The issue of NLP prejudice has therefore become a topic of interest within my internet artwork endeavours.</p>
<p>As we are now aware of the colonized nature of technology, the question of correction is raised. Adams (2021, pp177) suggests that the initial step is ensuring that marginalized communities have access to information by creating content. This views a platform for more inclusive content to be produced. It is also suggested that algorithmic bias is highlighted so that it is corrected. In order to achieve this critical theory must be applied to development in order to negate what Adams phrases as a sort of digital apartheid. Decolonization of technology would supplement colonial holds of oppression over the global South (pp181). Efforts towards approaching development with an ethical point-of-view have been made in the example of AI Ethics Guidelines to be produced.&nbsp;</p>
<p>The second step towards more inclusive artificial intelligence is adapting the training methodology for NLP itself. Masakhane does just this as the research community has provided an open-source tool for creating NLP using low-resource languages on the continent. Masakhane further highlights the importance of low-resource languages through documentation of the language, adaptive model training and language preservation(Ahia et al. 2019, pp2).&nbsp;</p>
<p>While there are steps have been taken to rectify the historical inequality between the North/South in technology, there is still a far way to go. It is therefore of utmost importance for these racial biases in technology to be addressed and for applications to be developed with marginalized communities in mind.</p>
        </article>
...
<li className='author'>Ahia, I. <em>et al.</em> (2020) &lsquo;Masakhane -- Machine Translation For Africa&rsquo;. arXiv. Available at: <a href="https://doi.org/10.48550/arXiv.2003.11529" className='u-url refA'>https://doi.org/10.48550/arXiv.2003.11529</a>.</li>
<li className='author'><em>GEO: Geography and Environment - Wiley Online Library</em> (2015). Available at: <a href="https://rgs-ibg.onlinelibrary.wiley.com/doi/full/10.1002/geo2.8" className='u-url refA'>https://rgs-ibg.onlinelibrary.wiley.com/doi/full/10.1002/geo2.8</a> (Accessed: 1 June 2023).</li>
<li className='author'>Hovy, D. and Prabhumoye, S. (2021) &lsquo;Five sources of bias in natural language processing&rsquo;, <em>Language and Linguistics Compass</em>, 15(8), p. e12432. Available at: <a href="https://doi.org/10.1111/lnc3.12432" className='u-url refA'>https://doi.org/10.1111/lnc3.12432</a>.</li>
<li className='author'>Noble, S.U. (2018) &lsquo;Algorithms of Oppression: How Search Engines Reinforce Racism&rsquo;, in <em>Algorithms of Oppression</em>. New York University Press. Available at: <a href="https://doi.org/10.18574/nyu/9781479833641.001.0001" className='u-url refA'>https://doi.org/10.18574/nyu/9781479833641.001.0001</a>.</li>
