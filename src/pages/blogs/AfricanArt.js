...
<Helmet>
       ...
       {/* Entry Header that includes back button, essay banner, Title, description, Publishing date and sharing options */}
        ...
        <article className='h-card relatedCard'>
        <h5 className='relatedArticle p-name'>Ai Art on the Internet </h5>
        <p className='relatedSummary p-summary'> How can AI and the internet be used as artisitc tools and mediums.</p>
