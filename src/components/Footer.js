  ...
  render() {
    return (
      <footer className='footer h-card'>
       ...
       <li className='u-url footerLi'> <a href='https://github.com/' target='_blank' className='footerLink u-url'> Github</a></li>
       <li className='u-url footerLi'> <a href='https://github.com/' target='_blank' className='footerLink u-url'> LinkedIn</a></li>
      </footer>
    )
  }
}
